import { FLOOD_RISK_TIMELINE } from '@/data/mockData';
  ...
  return (
    <div className="panel p-4">
      <div className="flex items-center justify-between mb-4">
        ...
        <span className="text-[11px] text-slate-500 uppercase tracking-wider">Next 3 Hours</span>
      </div>

      <div className="flex items-stretch gap-2">
        {FLOOD_RISK_TIMELINE.map((point, idx) => {
          ...
          return (
            <div key={idx} className="flex-1 group">
              ...
              {idx < FLOOD_RISK_TIMELINE.length - 1 && (
